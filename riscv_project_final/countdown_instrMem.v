...
//
// FIX: Corrected LED address:
//   x6 = 256 (0x100) -> LED output (addr[9:8]=01 -> led_wr)
//   Was 512 (0x200) which mapped to sw_rd, not led_wr
// ============================================
...
module countdown_instrMem #(
    ...
    initial begin
        ...
        // addi x7, x0, 15   (starting count value)
        mem_bytes[4]  = 8'h93;
        mem_bytes[5]  = 8'h03;
        mem_bytes[6]  = 8'hF0;
        mem_bytes[7]  = 8'h00;

        // add x8, x7, x0    OUTER_LOOP  (x8 = working counter)
        mem_bytes[8]  = 8'h33;
        mem_bytes[9]  = 8'h84;
        mem_bytes[10] = 8'h03;
        mem_bytes[11] = 8'h00;

        // sw x8, 0(x6)      COUNT_DOWN  (display count on LEDs)
        mem_bytes[12] = 8'h23;
        mem_bytes[13] = 8'h20;
        mem_bytes[14] = 8'h83;
        mem_bytes[15] = 8'h00;
        ...
        // addi x8, x8, -1   (decrement counter)
        mem_bytes[20] = 8'h13;
        mem_bytes[21] = 8'h04;
        mem_bytes[22] = 8'hF4;
        mem_bytes[23] = 8'hFF;
        ...
        // jal x0, COUNT_DOWN  (back to top of countdown)
        mem_bytes[36] = 8'h6F;
        mem_bytes[37] = 8'hF0;
        mem_bytes[38] = 8'h9F;
        mem_bytes[39] = 8'hFE;

        // sw x0, 0(x6)      RESET_COUNT  (clear LEDs briefly)
        mem_bytes[40] = 8'h23;
        mem_bytes[41] = 8'h20;
        mem_bytes[42] = 8'h03;
        mem_bytes[43] = 8'h00;

        // jal x0, OUTER_LOOP  (repeat from 15)
        mem_bytes[44] = 8'h6F;
        mem_bytes[45] = 8'hF0;
        mem_bytes[46] = 8'hDF;
        mem_bytes[47] = 8'hFD;
